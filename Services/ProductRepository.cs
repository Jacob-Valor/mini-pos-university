...
public sealed class ProductRepository : IProductRepository
{
    ...
    public async Task<bool> AddProductAsync(Product product)
    {
        try
        {
            ...
            command.Parameters.AddWithValue("@min", product.MinQuantity);
            ...
            Log.Information("Product added: {ProductName} ({Barcode})", product.Name, product.Id);
            return true;
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> UpdateProductAsync(Product product)
    {
        try
        {
            ...
            await command.ExecuteNonQueryAsync();
            Log.Information("Product updated: {ProductName} ({Barcode})", product.Name, product.Id);
            return true;
        }
        catch (Exception ex)
        {
            Log.Error(ex, "Error updating product: {Barcode}", product.Id);
            return false;
        }
    }
